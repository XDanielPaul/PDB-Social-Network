...
class TagController(Controller):
    ...
    @post(path="/", dto=PartialTagPostDTO)
    ...
    @delete(path="/{id:uuid}", status_code=200)
    async def delete_tag(self, id: UUID, db_session: AsyncSession) -> TagReturn:
